...
/* Generation options: */
#ifndef __model_mkTbRightArithmeticPipelined_h__
#define __model_mkTbRightArithmeticPipelined_h__
...
/* Class declaration for a model of mkTbRightArithmeticPipelined */
class MODEL_mkTbRightArithmeticPipelined : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTbRightArithmeticPipelined *mkTbRightArithmeticPipelined_instance;
 ...
 /* Constructor */
 public:
  MODEL_mkTbRightArithmeticPipelined();
...
#endif /* ifndef __model_mkTbRightArithmeticPipelined_h__ */
